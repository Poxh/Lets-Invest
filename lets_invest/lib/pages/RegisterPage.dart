          ...
          children: [
              ...
              onTap: () {
                showModalBottomSheet(context: context, builder: (BuildContext buildContext) {
                  return Container(
                    height: 200.h,
                    color: Colors.red,
                    child: Lottie.network("https://assets1.lottiefiles.com/packages/lf20_jbrw3hcz.json", width: 300, height: 300)
                  );
                });
              },
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    BuilderAPI.buildText(text: "Forgot Password?", color: Color.fromARGB(255, 67, 11, 165), 
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  BuilderAPI.buildText(text: "Already have an account?", color: Colors.white, 
                  fontSize: 15.sp, fontWeight: FontWeight.bold),
                  Padding(
                    padding: EdgeInsets.only(left: 5.w),
                    child: BuilderAPI.buildText(text: "Sign in", color: Color.fromARGB(255, 67, 11, 165), 
                    fontSize: 15.sp, fontWeight: FontWeight.bold),
                  )
  ...
  Widget buildSignUpButton(BuildContext context) {
    return Padding(
        ...
        child: ElevatedButton(
          ...
          onPressed: () async {
            String message = await firebaseAuthenticationAPI.signUp(email: emailController.text, password: passwordController.text) as String;
              ...
              if(!message.contains("successfull")) {
                showModalBottomSheet(context: context, builder: (BuildContext buildContext) {
                  return Container(
                    ...
                    child: Column(
                      children: [
                        Lottie.network("https://assets1.lottiefiles.com/packages/lf20_nfojqrzy.json", width: 110.w, height: 110.h),
                        Padding(
                          padding: EdgeInsets.only(left: 25.w, right: 25.w, bottom: 10.h),
                          child: BuilderAPI.buildText(text: "Warning", color: Colors.red, fontSize: 21.sp, fontWeight: FontWeight.bold)
                        ),
                        Padding(
                          padding: EdgeInsets.only(left: 25.w, right: 25.w),
                          child: BuilderAPI.buildText(text: message, color: Colors.white, fontSize: 21.sp, fontWeight: FontWeight.bold)
                        )
                      ],
                    )
                  );
